...
<caption>
    ...
    <table class="table table-secondary  table-hover">
      ...
      <tr>
        <td><button class="btn btn-success glyphicon glyphicon-pencil" data-toggle="modal" data-target="#modalInformacionAlumnoAlumno" onclick="InformacionformAlumnoAlumno('<?php echo $datos ?>')"><?php echo $ver[1] ?>
            
          </button></td>
        <td><?php echo $ver[2] ?></td>


        <td><button class="btn btn-warning glyphicon glyphicon-pencil" data-toggle="modal" data-target="#modalEdicionTAlumno" onclick="agregaformALUCursoAlumno('<?php echo $datos ?>')"> <?php echo $ver[17] ?>--<?php echo $ver[8] ?>
