function agregardatosAlumnosPRIEUnico(nombreAlumnos,dniAlumnosTA,cuilAlumnos,domicilioAlumnos,emailAlumnos,telefonoAlumnos,discapasidadAlumnos,cursoAlumnos,nombreTutor,dniTutor,TelefonoTutor,obserbacionGeneral,passLogin,passLogin2,planAñoAlumnoPRET,especialidadAlumnoPREtt){
	...
	cadena="nombreAlumnos=" + nombreAlumnos + 
			...
			"&planAñoAlumnoPRET=" + planAñoAlumnoPRET+
			"&especialidadAlumnoPREtt=" + especialidadAlumnoPREtt;
...
if (passLogin===passLogin2) {
 ...
 alertify.confirm('Administrador', '<h3>Los datos del Formularios son: </h3>'+
 									...
 									'<br><br><b><u>CORRESPONDE A:</u></b>'+planAñoAlumnoPRET+
 									'<br><b><u>ORIENTACIÓN</u></b>'+especialidadAlumnoPREtt+
 									'<br><b><u>CURSO:</u></b>'+cursoAlumnos+
 									'<br><br><b><u>Nombre y Apellido del Tutor:</u></b>'+nombreTutor+
 									'<br><b><u>DNI del Tutor:</u></b>'+dniTutor+
 									'<br><b><u>TELEFONO del Tutor:</u></b>'+TelefonoTutor+
...
function cursobuscarTotal(planAñoAlumnoPRET,especialidadAlumnoPREtt){




	cadena="planAñoAlumnoPRET=" + planAñoAlumnoPRET + 
			"&especialidadAlumnoPREtt=" + especialidadAlumnoPREtt;


	$.ajax({
		type:"POST",
		url:"php/crearSeccionTotal.php",
		data:cadena,
		success:function(res){
			if(res==1){
				
			
				$("#cursosPRE").load('php/buscarCurso.php');
