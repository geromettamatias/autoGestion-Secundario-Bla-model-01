...
require_once "../../libreriasConexion/conexion.php";
	...
	$dniTutorRE=$_POST['dniTutorRE'];

$datos="1";
$CONTA=0;
$query = "SELECT * FROM `datosalumnos` WHERE `dniAlumnos`='$dniAlumnosRE' and `cuilAlumnos`='$cuilAlumnosRE' and `dniTutor`='$dniTutorRE'";
